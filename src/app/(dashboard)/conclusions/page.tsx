...
const WORST_FORMATS: ConclusionCard[] = [
  { id: 1, category: "eCPM", entity: "Slider", metricName: "Lowest Avg eCPM", metricValue: "$0.08", delta: -54.2, explanation: "Slider viewability dropped to 11% across all bundles. Most impressions below fold." },
  { id: 2, category: "Fill Rate", entity: "Vast", metricName: "Lowest Fill Rate", metricValue: "23%", delta: -31.0, explanation: "Two demand partners paused campaigns. Only one active bidder remaining on Trans and Hentai." },
  { id: 3, category: "Revenue Share", entity: "Banner", metricName: "Revenue Drop", metricValue: "-$420", delta: -28.6, explanation: "300x250 CTR fell to 0.02%. Advertisers shifting budget to outstream and pop." },
  { id: 4, category: "CTR", entity: "Outstream", metricName: "Lowest CTR", metricValue: "0.04%", delta: -19.3, explanation: "Autoplay blocked on 60% of mobile traffic. Completion rate under 15% on Hentai bundle." },
];

const BEST_FORMATS: ConclusionCard[] = [
  { id: 1, category: "eCPM", entity: "Pop", metricName: "Highest Avg eCPM", metricValue: "$1.24", delta: 18.6, explanation: "Strong demand from dating and gaming verticals. Gays bundle pop eCPM hit $1.67." },
  { id: 2, category: "Revenue", entity: "Push", metricName: "Top Revenue Growth", metricValue: "+$890", delta: 34.2, explanation: "Subscriber base grew 12% WoW. JAV push notifications averaging 8.4% CTR." },
  { id: 3, category: "Fill Rate", entity: "Banner", metricName: "Best Fill Rate", metricValue: "97%", delta: 4.1, explanation: "Added two new SSP integrations. Backfill catching remaining 3% on Gays bundle." },
  { id: 4, category: "Viewability", entity: "Outstream", metricName: "Best Viewability", metricValue: "72%", delta: 15.8, explanation: "Sticky placement on JAV sites boosted viewability. Completion rate up to 45%." },
];
...
export default function ConclusionsPage() {
  ...
  return (
    ...
    >
      ...
      <ConclusionSection title="Worst Sites" icon={AlertTriangle} accent="red" items={WORST_SITES} />
      <ConclusionSection title="Best Sites" icon={CheckCircle} accent="green" items={BEST_SITES} />
      <ConclusionSection title="Worst Formats" icon={Layers} accent="red" items={WORST_FORMATS} />
      <ConclusionSection title="Best Formats" icon={BarChart3} accent="green" items={BEST_FORMATS} />
    </motion.div>
  );
}
